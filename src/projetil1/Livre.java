...
public class Livre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajoutez un Livre");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(jPanel1, "Livre Ajoutée avec succès", "Information Message" , JOptionPane.INFORMATION_MESSAGE);
              Ressources ress = new Ressources();
              ress.setVisible(true);
              Livre.this.setVisible(false);
