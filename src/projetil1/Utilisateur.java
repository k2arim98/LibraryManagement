...
public class Utilisateur extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(152, 153, 255));
        jButton1.setText("Empruntez");
        ...
        jButton2.setBackground(new java.awt.Color(152, 153, 255));
        ...
        jLabel1.setBackground(new java.awt.Color(152, 153, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
              ...
              try (Connection connection = DriverManager.getConnection(postgresURL,username,password)) {
                  String sql ="INSERT INTO public.\"UtilTable\"(nom,prenom,caution,dateretour)"+ "VALUES("+"\'"+jTextField1.getText()+"\'"+","+"\'"+jTextField2.getText()+"\'"+","+"\'"+jFormattedTextField2.getText()+"\'"+","+"\'"+jFormattedTextField1.getText()+"\'"+");";  
              ...
              Exemplaire ress = new Exemplaire();
              ress.setVisible(true);
              Utilisateur.this.setVisible(false);
